...
#include "LordVoldebot.h"
using namespace std;

std::chrono::time_point<std::chrono::high_resolution_clock> start;
std::chrono::milliseconds limit(1900);

LordVoldebot::LordVoldebot()
{
...
void LordVoldebot::initialize()
{
    // Inicializar el bot antes de jugar una partida
}

string LordVoldebot::getName()
{
    return "LordVoldebot"; // Sustituir por el nombre del bot
}

std::pair<double, Move> LordVoldebot::AlphaBeta(Node node, int depth, int alpha,
...
Move LordVoldebot::nextMove(const vector<Move>& adversary, const GameState& state)
{
